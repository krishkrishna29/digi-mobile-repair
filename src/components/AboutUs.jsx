      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-24">
            ...
            <div className="flex flex-wrap justify-center gap-8 sm:gap-12">
                {[
                    { name: "Prakash Kumar", role: "Lead Technician", img: "/path-to-your-image.jpg" },
                    { name: "Bishwojit Behera", role: "Customer Support Lead", img: "/path-to-your-image.jpg" },
                    { name: "Subham Dash", role: "Hardware Specialist", img: "/path-to-your-image.jpg" },
                ].map(member => (
        ...
        <div className="text-center bg-gray-800 p-10 rounded-2xl shadow-xl">
          ...
          <a href="/new-repair" className="bg-gradient-to-r from-blue-500 to-pink-500 text-white font-bold py-3 px-8 rounded-full hover:scale-105 transform transition-transform duration-300 inline-block">
