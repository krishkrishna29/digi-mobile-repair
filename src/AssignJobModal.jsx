        ...
        <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
                <div className="mt-3 text-center">
                    <h3 className="text-lg leading-6 font-medium text-black">Assign Repair Job</h3>
                    <div className="mt-2 px-7 py-3">
                        ...
                        >
                            <option value="" className="text-gray-700">Select Technician</option>
                            {technicians.map((tech) => (
                                <option key={tech.id} value={tech.id} className="text-gray-700">{tech.fullName || tech.email}</option>
                            ))}
                        </select>
                    </div>
